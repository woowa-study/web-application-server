...
public class GetDefaultPathHandler implements PathHandleStrategy {
    @Override
    public void response(HttpRequestDto httpRequestDto, DataOutputStream dos) {
        byte[] body;
        try {
            body = Files.readAllBytes(Paths.get("/Users/kimkyunam/Documents/workspace/web-application-server/webapp/index.html"));
